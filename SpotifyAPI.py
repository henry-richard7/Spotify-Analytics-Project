        ...
        results.append(
            {
                ...
                "danceability": track_meta.get("danceability",0) if track_meta else 0,
                "energy": track_meta.get("energy",0) if track_meta else 0,
                "key": track_meta.get("key",0) if track_meta else 0,
                "loudness": track_meta.get("loudness",0) if track_meta else 0,
                "mode": track_meta.get("mode",0) if track_meta else 0,
                "speechiness": track_meta.get("speechiness",0) if track_meta else 0,
                "acousticness": track_meta.get("acousticness",0) if track_meta else 0,
                "instrumentalness": track_meta.get("instrumentalness",0) if track_meta else 0,
                "liveness": track_meta.get("liveness",0) if track_meta else 0,
                "valence": track_meta.get("valence",0) if track_meta else 0,
                "tempo": track_meta.get("tempo",0) if track_meta else 0,
            }
        )
